...
acf_add_local_field_group(array (
	...
	'fields' => array (
		array (
			...
			'name' => 'add_slider',
			'type' => 'radio',
			'instructions' => 'If you prefer Revolution Slider or Layer Slider instead of the custom slider in this theme you can use them via this template by adding the <strong>ID only</strong> in the input fields. Please note that both premium sliders are not included with the theme.	You can buy Revolution Slider <a href="http://codecanyon.net/item/slider-revolution-responsive-wordpress-plugin/2751380?ref=QreativeThemes">here</a>, and Layer Slider <a href="http://codecanyon.net/item/layerslider-responsive-wordpress-slider-plugin-/1362246?ref=QreativeThemes">here</a>',
			'required' => 1,
			'conditional_logic' => 0,
			'wrapper' => array (
				'width' => '',
