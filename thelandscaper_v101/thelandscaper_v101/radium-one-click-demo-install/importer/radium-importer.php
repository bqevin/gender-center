	        ...
	        <div id="icon-tools" class="icon32"><br></div>
				...
				<form method="post">
					<div style="background-color: #F5FAFD; margin:10px 0;padding: 5px 10px;color: #0C518F;border: 2px solid #CAE0F3; clear:both; width:90%; line-height:18px;">
						<p class="tie_message_hint">Importing demo data (post, pages, images, theme settings, ...) is the easiest way to setup your theme.
					...
					<div style="background-color: #F5FAFD; margin:10px 0;padding: 5px 10px;color: #0C518F;border: 2px solid #CAE0F3; clear:both; width:90%; line-height:18px;">
						<h1>Read First</h1>
						<p>Before you begin, make sure all the required plugins are installed and <strong>activated</strong></p>
						<p>If you want to import the demo content manually for some reason see <a href="http://qreativethemes.com/docs/thelandscaper#manual-import-demo-content" target="_blank">the documentation</a></p>
					</div>
